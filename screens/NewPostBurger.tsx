...
const NewPostBurger = () => {
  ...
  return (
    <View style={styles.newPostBurger}>
      <View style={[styles.newPostBurgerChild, styles.newLayout]} />
      <View style={[styles.newPostBurgerItem, styles.groupChildPosition]} />
      <View style={[styles.newPostBurgerInner, styles.lineViewLayout]} />
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("NewPostBurgerWithCaption")}
      />
      ...
      <Pressable
        style={styles.newPostBurgerChild1}
