...
const NewPostBurgerWithCaption = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.newPostBurgerWithCaption}>
      <View style={[styles.newPostBurgerWithCaptionChild, styles.newLayout]} />
      <Image
        style={styles.newPostBurgerWithCaptionItem}
        contentFit="cover"
        source={require("../assets/rectangle-10.png")}
      />
      <View
        style={[
          styles.newPostBurgerWithCaptionInner,
          styles.groupChildPosition,
        ]}
      />
      <View style={[styles.lineView, styles.lineViewLayout]} />
      <View
        style={[styles.newPostBurgerWithCaptionChild1, styles.lineViewLayout]}
      />
      ...
      <Text style={[styles.thisHamburgerIs, styles.descriptionTypo]}>
        This hamburger is AWESOME
      </Text>
      <View style={styles.newPostBurgerWithCaptionChild2} />
      ...
      <View style={[styles.rectangleParent, styles.rectangleLayout]}>
        ...
        <Text style={[styles.addPollLink, styles.descriptionTypo]}>
...
const styles = StyleSheet.create({
  ...
  newPostBurgerWithCaptionChild1: {
    top: 708,
  ...
  newPostBurgerWithCaptionChild2: {
    top: 227,
    height: 98,
    width: 345,
    backgroundColor: Color.colorDarkslategray_100,
